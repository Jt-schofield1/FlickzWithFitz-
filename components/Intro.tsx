/**
 * Page-load curtain. Wipes upward and is gone by ~0.85s — the headline reveal
 * underneath is timed to arrive with it, not after it, so nothing here waits
 * on assets.
 */
export default function Intro() {
  return (
    <div
      ...
      style={{ animation: 'introOut .8s .05s cubic-bezier(.76,0,.24,1) forwards' }}
    >
      <div
        style={{
